# PRIVACY POLICY / PRIVATLIVSPOLITIK - LANTERNE

Last Updated / Sidst opdateret: March 17, 2026 / 17. marts 2026

---

## ENGLISH VERSION

Lanterne is committed to protecting your privacy. This policy explains how we handle your data in accordance with applicable regulations, including GDPR and Chrome Web Store policies.

### 1. DATA CONTROLLER
As the developer of Lanterne, I am the data controller for the limited processing of information that takes place. Since Lanterne is a "local-first" extension, most data is stored only on your own device.

### 2. DATA COLLECTION AND USE
Lanterne only collects data that is strictly necessary to provide the extension's features.
...
The use of information received from Google APIs will adhere to the Chrome Web Store User Data Policy, including the Limited Use requirements. This means data is only used to provide or improve the extension's core functionality.

### 5. YOUR RIGHTS (GDPR)
Under GDPR, you have the following rights:
*   **Access and Deletion:** Since your data is stored locally, you have full control over it. You can delete your data at any time by removing the extension or clearing its data in browser settings.
*   **Complaint:** You have the right to lodge a complaint with your local data protection authority (e.g., Datatilsynet in Denmark, www.datatilsynet.dk) if you are dissatisfied with how we handle your data.

### 6. SECURITY
We prioritize the security of your data. All communication with third-party APIs (like Open-Meteo) occurs via encrypted HTTPS connections.

### 7. CONTACT
If you have questions about this privacy policy, you can contact the developer via the support channel in the Chrome Web Store.

---

## DANSK VERSION

Lanterne er dedikeret til at beskytte dit privatliv. Denne politik forklarer, hvordan vi håndterer dine data i overensstemmelse med de gældende regler, herunder GDPR og Chrome Web Stores politikker.

### 1. DATAANSVARLIG
Som udvikler af Lanterne er jeg dataansvarlig for den begrænsede behandling af oplysninger, der finder sted. Da Lanterne er en "local-first" extension, opbevares de fleste data kun på din egen enhed.

### 2. INDSAMLING OG ANVENDELSE AF DATA
Lanterne indsamler kun de data, der er strengt nødvendige for at levere extensionens funktioner.
...
### 4. LIMITED USE DISCLOSURE (BEGRÆNSET ANVENDELSE)
Anvendelsen af oplysninger modtaget fra Google API'er vil overholde Chrome Web Store User Data Policy, herunder "Limited Use" kravene. Det betyder, at data kun bruges til at levere eller forbedre extensionens kernefunktionalitet.

### 5. DINE RETTIGHEDER (GDPR)
I henhold til GDPR har du følgende rettigheder:
*   **Indsigt og sletning:** Da dine data gemmes lokalt, har du fuld kontrol over dem. Du kan til enhver tid slette dine data ved at fjerne extensionen eller rydde dens data i browserindstillingerne.
*   **Klage:** Du har ret til at indgive en klage til Datatilsynet (www.datatilsynet.dk), hvis du er utilfreds med, hvordan vi håndterer dine data.

### 6. SIKKERHED
Vi prioriterer sikkerheden af dine data. Al kommunikation med tredjeparts-API'er (som Open-Meteo) sker via krypterede HTTPS-forbindelser.

### 7. KONTAKT
Hvis du har spørgsmål til denne privatlivspolitik, kan du kontakte udvikleren via support-kanalen i Chrome Web Store.
